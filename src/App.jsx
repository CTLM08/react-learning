...
const App = () => {
  ...
  {/* flex(整个区域) justify-center items-center(区域中间) */}
      ...
      <img src={apple} className='w-64 md:w-96 rounded-xl bg-green-200  '></img>
      

      <div className='p-5'>
      <div className='text-base md:text-xl font-bold '>apple with 'apple'</div>
      <div ><span className='text-slate-600 md:text-base'>by</span><span> </span><span className='text-slate-600  font-bold'>LIMING</span></div>
      <div className=''><span className='text-base md:text-xl font-bold text-slate-600 mt-2 tracking-wide'>$40000</span><span className='text-slate-600 font-bold'> offer now!!</span></div>
    ...
    <div className='absolute bottom-0  text-neutral-600'>
      made by <span className="text-black font-['Iceberg'] text-base md:text-xl" >MRGA</span>.All right reserved
    </div>
